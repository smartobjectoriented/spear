        ...
        ToolSpec(
            ...
            {"type": "object", "properties": {
                ...
                "disposition": string(
                    ...
                    "before you modify the files THAT CHANGE touches -- not before "
            "you may work at all: requirements about other code stay open and "
            "are asked for at the end. Plan the one change you are about to "
            "make, make it, prove it, then take the next. `undetermined` is "
            "for a "
